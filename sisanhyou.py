...
def create_gui():
    ...
    try:
        ...
        c.execute("INSERT INTO item VALUES(15,'家賃')")
        c.execute("INSERT INTO item VALUES(16,'水道光熱費')")
        c.execute("INSERT INTO item VALUES(17,'通信費')")
        c.execute("INSERT INTO item VALUES(18,'月謝')")
        c.execute("INSERT INTO item VALUES(19,'保険料')")
        c.execute("COMMIT")
    except:
        pass
...
def select_gui():
    ...
    tree2 = ttk.Treeview(root,padding=10)
    tree2["columns"] = (1,2)
    tree2["show"] = "headings"
    ...
    tree2.pack(fill="x",padx=50,pady=90)
